...
class FourM(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.enc_norm = LayerNorm(dim, use_bias) # TODO: Define the encoder output layer normalization. Use the LayerNorm class defined in modeling/transformer_layers.py
        self.dec_norm = LayerNorm(dim, use_bias) # TODO: Define the decoder output layer normalization. Use the LayerNorm class defined in modeling/transformer_layers.py
    ...
    def generate_one_modality_roar(
        ...
        random_indices = torch.randperm(n_tokens_target, device=device).unsqueeze(0)
        ...
        dec_input_positions_list = torch.split(random_indices, schedule, dim=1)
